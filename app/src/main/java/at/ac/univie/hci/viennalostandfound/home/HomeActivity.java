...
public class HomeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoggedInUser loggedInUser = (LoggedInUser) savedInstanceState.get("loggedInUser");

        if (loggedInUser.getLoggedInState() == true) {
            String username = loggedInUser.getLoggedInUser().getName();
